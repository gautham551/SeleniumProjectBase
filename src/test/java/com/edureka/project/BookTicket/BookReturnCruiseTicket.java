...
public class BookReturnCruiseTicket extends BaseClass {
    Logger log = Logger.getLogger(BookReturnCruiseTicket.class);
    ...
    public void BookReturnTicketTest() {
        ...
        CruisesPage cruise = PageFactory.initElements(driver, CruisesPage.class);
        log.info("Step 1 - Clicked on Cruise Link");
        cruise.getCruisesLink().click();;
        log.info("Step 2 - Click on Reservations of cruise Img" );
        cruise.getReservationsImglink().click();
        log.info("Step 3 - Assert if opened pageTitle is correct");
        ...
        log.info("Step 4-Check of the RoundTrip Radio button is selected");
